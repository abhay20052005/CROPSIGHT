      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary-dark to-green-900 p-12 flex-col justify-between relative overflow-hidden animate-fade-in-left">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-white/90 mb-8">
            ...
            Protect your harvest with instant diagnosis.
          </p>
          <div className="flex gap-8 text-white/80">
            ...
            <div>
              ...
              <div className="text-sm">Scans Completed</div>
            </div>
            <div>
            ...
            {loginMethod === 'email' ? (
              <>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-sm text-primary hover:text-primary-dark font-semibold">
                    Forgot password?
                  </Link>
                </div>
              </>
